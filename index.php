                ...
                <div class="col-xl-4 col-md6 mb-4">
                    <div class="card border-left-danger shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="font-weight-bold text-danger text-uppercase mb-1">Total Cashin as of Date:
                                    </div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                ...
                <div class="col-xl-4 col-md6 mb-4">
                    <div class="card border-left-success shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="font-weight-bold text-success text-uppercase mb-1">Total Cashout as of Date:
                                    </div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if ($transcations["vendor_id"] == '27') {
                                                echo "Maria Pauline";
                                            }
                                            else if($transcations["vendor_id"] == '28'){
